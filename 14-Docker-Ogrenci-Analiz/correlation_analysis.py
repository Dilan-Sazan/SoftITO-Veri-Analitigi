...
numeric_columns = ['Matematik', 'Fizik', 'Kimya', 'Türkçe', 'İngilizce', 'Bilgisayar', 'Ortalama','Katılım','Devamsızlık']
...
print(f'Correlation between Ortalama and Katılım: {katilim_correlation:.4f}')
print(f'Correlation between Ortalama and Devamsızlık: {devamsizlik_correlation:.4f}')

print(f'\n Katılım ← → Ortalama: {katilim_correlation:.4f}')
print(f' → Katılım artıkça Ortalama {'artar' if katilim_correlation > 0 else 'azalır'}')
